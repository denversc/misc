...
exec podman run -it \
  -v /Volumes/dev/gcloud-podman/dev01-493607-71c679891ef4.json:/dev01-493607-71c679891ef4.json:Z \
  -v /Volumes/dev/gcloud-podman/config:/root/.config/gcloud:Z \
  -v /Volumes/dev/gcloud-podman/.bash_history:/root/.bash_history:Z \
